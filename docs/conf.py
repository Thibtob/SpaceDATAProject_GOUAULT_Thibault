...
import os
import sys
sys.path.insert(0, os.path.abspath('C:/Users/utilisateur/Documents/COURS 5A ESPACE/COURS 5A/TRONC COMMUN/Space DATA\projet Github/python_project_template-main/src'))
